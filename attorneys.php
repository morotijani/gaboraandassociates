        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 caption mt-60 text-center">
                    <h6><div class="icon"><i class="flaticon-courthouse"></i></div> Qualified experts</h6>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <div class="info">
                            <h5><a href="team-details.html">Rhea McKean</a></h5>
                            <p>Criminal Lawyer</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <div class="info">
                            <h5><a href="team-details.html">Martin Brown</a></h5>
                            <p>Family Lawyer</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <div class="info">
                            <h5><a href="team-details.html">Sophia Mia</a></h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <div class="info">
                            <h5><a href="team-details.html">Emily Lucas</a></h5>
                            <p>Business Lawyer</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <div class="info">
                            <h5><a href="team-details.html">Olivia Wilson</a></h5>
                            <p>Divorce Lawyer</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <div class="info">
                            <h5><a href="team-details.html">Ranish Moore</a></h5>
                            <p>Criminal Lawyer</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <div class="info">
                            <h5><a href="team-details.html">Noah Taylor</a></h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <div class="info">
                            <h5><a href="team-details.html">Henry Miller</a></h5>
                            <p>Bankruptcy Lawyer</p>
                        </div>
                    </div>
                </div>
            </div>
